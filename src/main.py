...
def read_sumo_files_and_calculate_uct_stats(fcd_file: str, net_file: str, eNodeB_mec_config_file: str):
    ...
    car_time_locations_raw = load_fcd_data_parallel(fcd_file)
    read_config_and_execute_runs(car_time_locations_raw, net_file, eNodeB_mec_config_file)
...
net_file = '/home/chris/Documents/STUDIA/Praca_mgr/Symulacje/v2x-mec/sumo/s8-big/osm.net.xml'
fcd_file = '/home/chris/Documents/STUDIA/Praca_mgr/Symulacje/v2x-mec/sumo/s8-big/fcd-output.xml'
eNodeB_mec_config_file = '/home/chris/Documents/STUDIA/Praca_mgr/Symulacje/v2x-mec/bts/bts-mec-conf.json'
